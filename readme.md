...
![Рис.1. Пояснение терминов развертка, ось, сегмент.](for_docs/how_it_should_work.drawio.svg)
...
![Рис. 2. Пример задачи.](for_docs/trgt.png)
...
![Рис. 3. Представление развертки на начальной стадии. ](for_docs/1.png)
...
![Рис. 4. Вид представления после первого сгиба.](for_docs/2.png)
...
![Рис. 5. Вид представления после второго сгиба.](for_docs/3.png)
...
![Рис. 6. Пример для пояснения алгоритма поиска всех путей.](for_docs/Untitled.png)
...
![Рис. 7. Дерево путей для рис. 6.](for_docs/Untitled%201.png)
...
![Рис. 9. Развертка из задания.](for_docs/Untitled%202.png)
...
![Рис. 10. Дерево путей для развертки из задания.](for_docs/Screenshot_2022-05-15_122011.png)

Рис. 10. Дерево путей для развертки из задания.

![Рис. 11. Дерево путей после работы оптимизированного алгоритма. ](for_docs/Untitled%203.png)
...
![Рис. 12. Единственный путь решения: DHCGBFAE.](for_docs/Untitled%204.png)
...
![            Рисунок 2. Paddings.](for_docs/how_it_should_work.drawio%201.svg)
...
![Пример “чистой гармошки”](for_docs/Untitled%205.png)
