...
function getMain(req, res) {
    ...
    try {
        var html = (0, fs_1.readFileSync)(path_1.default.resolve(__dirname, "../web/public/index.html"), {
            encoding: "utf8",
        });
        console.log(__dirname);
        console.log((0, fs_1.readdir)(__dirname, function (err, files) {
            console.log(files);
        }));
        console.log(html);
        res.status(200);
...
app.get(/\.(js|css|map|png|jp[2g]|webp|tiff|jfif|jpeg(2000)?|ico|bem|gif|svg)$/, express_1.default.static("web/public"));
app.get("/", getMain);
...
app.get(API_URL + "/getTask", function (req, res) {
    var _a;
    var QDificulty = +(((_a = req.query) === null || _a === void 0 ? void 0 : _a.difficulty) || "").toString();
    res.contentType("application/json");
    try {
        (0, fs_1.readdir)(path_1.default.resolve(__dirname, "../examples/difficulty_".concat(QDificulty)), function (err, items) {
            ...
            var file = (0, fs_1.readFileSync)(path_1.default.resolve(__dirname, "../examples/difficulty_".concat(QDificulty, "/"), fileName));
            res.status(200);
            res.send(file);
        });
    }
